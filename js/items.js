...
export const DINGE = {
  /* ------------------------------- Waffen -------------------------------- */
  knueppel:    { name: 'Knüppel',        art: 'waffe', icon: '🏏', schaden: 3,  wert: 18,  rang: 0,
                 klinge: '#9a6138', griff: '#7a4a2e',
                 text: 'Ein Ast mit Entschlossenheit.' },
  kurzschwert: { name: 'Kurzschwert',    art: 'waffe', icon: '🗡️', schaden: 7,  wert: 70,  rang: 1,
                 klinge: '#d8dde2', griff: '#8a5230',
                 text: 'Handlich. Tut, was man von ihm erwartet.' },
  streitkolben:{ name: 'Streitkolben',   art: 'waffe', icon: '🔨', schaden: 11, wert: 150, rang: 2,
                 klinge: '#b9aa98', griff: '#5e4634',
                 text: 'Gegen Knochen besonders überzeugend.' },
  langschwert: { name: 'Langschwert',    art: 'waffe', icon: '⚔️', schaden: 16, wert: 320, rang: 3,
                 klinge: '#e6ecf2', griff: '#4a3b30',
                 text: 'Reichweite ist die halbe Miete.' },
  runenklinge: { name: 'Runenklinge',    art: 'waffe', icon: '🌟', schaden: 24, wert: 760, rang: 4,
                 klinge: '#9fd8e8', griff: '#3f3a52',
                 text: 'Die Zeichen darauf liest niemand mehr.' },

  /* ------------------------------ Rüstungen ------------------------------ */
  wams:        { name: 'Lederwams',      art: 'ruestung', icon: '🎽', panzer: 0.07, wert: 55,  rang: 1,
                 text: 'Hält den Wind ab und manchmal mehr.' },
  kettenhemd:  { name: 'Kettenhemd',     art: 'ruestung', icon: '🛡️', panzer: 0.14, wert: 170, rang: 2,
                 text: 'Schwer, laut, sein Geld wert.' },
  schuppen:    { name: 'Schuppenpanzer', art: 'ruestung', icon: '🐲', panzer: 0.22, wert: 420, rang: 3,
                 text: 'Woher die Schuppen stammen, sagt der Händler nicht.' },
  grabharnisch:{ name: 'Grabharnisch',   art: 'ruestung', icon: '⚜️', panzer: 0.3,  wert: 880, rang: 4,
                 text: 'Jemand hat ihn lange getragen. Sehr lange.' },

  /* ------------------------------- Schmuck ------------------------------- */
  kraftamulett:{ name: 'Amulett der Kraft', art: 'schmuck', icon: '📿', schaden: 5,  wert: 190, rang: 2,
                 text: 'Der Arm wird nicht müder, nur überzeugter.' },
  lebensring:  { name: 'Ring des Atems',    art: 'schmuck', icon: '💍', leben: 30,   wert: 220, rang: 2,
                 text: 'Man steht ein wenig länger.' },
  magiestein:  { name: 'Quellstein',        art: 'schmuck', icon: '🔮', magicka: 35, wert: 210, rang: 2,
                 text: 'Kalt, auch in der Sonne.' },
  wanderschuh: { name: 'Schuhe des Boten',  art: 'schmuck', icon: '🥾', tempo: 0.18, wert: 240, rang: 3,
                 text: 'Sie kennen den Weg besser als du.' },

  /* -------------------------------- Tränke ------------------------------- */
  heiltrank:   { name: 'Heiltrank',      art: 'trank', icon: '🧪', heilt: 50, wert: 40, rang: 1,
                 text: 'Schmeckt nach Eisen und Minze.' },
  magietrank:  { name: 'Quelltrank',     art: 'trank', icon: '⚗️', magie: 45, wert: 35, rang: 1,
                 text: 'Prickelt hinter der Stirn.' },

  /* -------------------------------- Krempel ------------------------------ */
  wolfsfell:   { name: 'Wolfsfell',      art: 'beute', icon: '🧶', wert: 14, rang: 0,
                 text: 'Der Kürschner nimmt es.' },
  knochen:     { name: 'Alter Knochen',  art: 'beute', icon: '🦴', wert: 9,  rang: 0,
                 text: 'Von jemandem, der nicht mehr fragt.' },
  glimmstein:  { name: 'Glimmstein',     art: 'beute', icon: '💎', wert: 30, rang: 1,
                 text: 'Leuchtet noch schwach.' },
  becher:      { name: 'Silberbecher',   art: 'beute', icon: '🏆', wert: 65, rang: 2,
                 text: 'Ein Wappen darauf, das keiner kennt.' },
  siegel:      { name: 'Altes Siegel',   art: 'beute', icon: '📜', wert: 120, rang: 3,
