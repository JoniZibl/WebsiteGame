...
export const BEWOHNER = {
  ...
  wald:    { tag: [['reh', 3], ['keiler', 2], ['wolf', 2]],
             nacht: [['wolf', 4], ['raeuber', 2], ['nachtmahr', 0.6]] },
  heide:   { tag: [['schaf', 3], ['keiler', 2], ['wolf', 1], ['raeuber', 1]],
             nacht: [['wolf', 3], ['raeuber', 2], ['skelett', 1]] },
  steppe:  { tag: [['hase', 2], ['raeuber', 3], ['wolf', 2]],
             nacht: [['raeuber', 3], ['skelett', 2], ['nachtmahr', 0.5]] },
